...
//        g.display();
        ...
        g.getNode("0").addAttribute("age", "44");
        g.getNode("0").addAttribute("language", "Aro");
        g.addNode("1");
        g.getNode("1").addAttribute("name", "Muhammad");
        g.getNode("1").addAttribute("age", "42");
        g.getNode("1").addAttribute("language", "Ada");
        g.addNode("2");
        g.getNode("2").addAttribute("name", "Nur");
        g.getNode("2").addAttribute("age", "2");
        g.getNode("2").addAttribute("language", "ALGOL");
        g.addNode("3");
        g.getNode("3").addAttribute("name", "Dewi");
        g.getNode("3").addAttribute("age", "33");
        g.getNode("3").addAttribute("language", "Applescript");
        g.addNode("4");
        g.getNode("4").addAttribute("name", "Tri");
        g.getNode("4").addAttribute("age", "8");
        g.getNode("4").addAttribute("language", "Assembly");
        g.addNode("5");
        g.getNode("5").addAttribute("name", "Dian");
        g.getNode("5").addAttribute("age", "26");
        g.getNode("5").addAttribute("language", "BASIC");
        g.addNode("6");
        g.getNode("6").addAttribute("name", "Sri");
        g.getNode("6").addAttribute("age", "30");
        g.getNode("6").addAttribute("language", "ASP");
        g.addNode("7");
        g.getNode("7").addAttribute("name", "Putri");
        g.getNode("7").addAttribute("age", "2");
        g.getNode("7").addAttribute("language", "BASIC");
        g.addNode("8");
        g.getNode("8").addAttribute("name", "Eka");
        g.getNode("8").addAttribute("age", "10");
        g.getNode("8").addAttribute("language", "COMAL");
        g.addNode("9");
        g.getNode("9").addAttribute("name", "Sari");
        g.getNode("9").addAttribute("age", "43");
        g.getNode("9").addAttribute("language", "Visual Basic");
        g.addNode("10");
        g.getNode("10").addAttribute("name", "Ayu");
        g.getNode("10").addAttribute("age", "6");
        g.getNode("10").addAttribute("language", "Visual Basic for Applications");
        g.addNode("11");
        g.getNode("11").addAttribute("name", "Wahyu");
        g.getNode("11").addAttribute("age", "22");
        g.getNode("11").addAttribute("language", "VBScript");
        g.addNode("12");
        g.getNode("12").addAttribute("name", "Indah");
        g.getNode("12").addAttribute("age", "16");
        g.getNode("12").addAttribute("language", "BAIK");
        g.addNode("13");
        g.getNode("13").addAttribute("name", "Siti");
        g.getNode("13").addAttribute("age", "37");
        g.getNode("13").addAttribute("language", "Batch (MS-DOS)");
        g.addNode("14");
        g.getNode("14").addAttribute("name", "Ika");
        g.getNode("14").addAttribute("age", "42");
        g.getNode("14").addAttribute("language", "COBOL");
        g.addNode("15");
        g.getNode("15").addAttribute("name", "Agus");
        g.getNode("15").addAttribute("age", "8");
        g.getNode("15").addAttribute("language", "UNIX shell script:");
        g.addNode("16");
        g.getNode("16").addAttribute("name", "Fitri");
        g.getNode("16").addAttribute("age", "41");
        g.getNode("16").addAttribute("language", "Bourne shell (sh) script");
        g.addNode("17");
        g.getNode("17").addAttribute("name", "Ratna");
        g.getNode("17").addAttribute("age", "31");
        g.getNode("17").addAttribute("language", "Bourne-Again shell (bash) script");
        g.addNode("18");
        g.getNode("18").addAttribute("name", "Andi");
        g.getNode("18").addAttribute("age", "31");
        g.getNode("18").addAttribute("language", "Korn shell (ksh) script");
        g.addNode("19");
        g.getNode("19").addAttribute("name", "Agung");
        g.getNode("19").addAttribute("age", "3");
        g.getNode("19").addAttribute("language", "C shell (csh) script");
        g.addNode("20");
        g.getNode("20").addAttribute("name", "Ahmad");
        g.getNode("20").addAttribute("age", "36");
        g.getNode("20").addAttribute("language", "C");
        g.addNode("21");
        g.getNode("21").addAttribute("name", "Kurniawan");
        g.getNode("21").addAttribute("age", "14");
        g.getNode("21").addAttribute("language", "C++™");
        g.addNode("22");
        g.getNode("22").addAttribute("name", "I");
        g.getNode("22").addAttribute("age", "44");
        g.getNode("22").addAttribute("language", "C#™");
        g.addNode("23");
        g.getNode("23").addAttribute("name", "Budi");
        g.getNode("23").addAttribute("age", "25");
        g.getNode("23").addAttribute("language", "Visual C++");
        g.addNode("24");
        g.getNode("24").addAttribute("name", "Adi");
        g.getNode("24").addAttribute("age", "49");
        g.getNode("24").addAttribute("language", "ColdFusion");
        g.addNode("25");
        g.getNode("25").addAttribute("name", "Eko");
        g.getNode("25").addAttribute("age", "19");
        g.getNode("25").addAttribute("language", "dBase dkk.");
        g.addNode("26");
        g.getNode("26").addAttribute("name", "Nurul");
        g.getNode("26").addAttribute("age", "12");
        g.getNode("26").addAttribute("language", "Clipper");
        g.addNode("27");
        g.getNode("27").addAttribute("name", "Putra");
        g.getNode("27").addAttribute("age", "16");
        g.getNode("27").addAttribute("language", "Foxbase");
        g.addNode("28");
        g.getNode("28").addAttribute("name", "Ni");
        g.getNode("28").addAttribute("age", "42");
        g.getNode("28").addAttribute("language", "Visual FoxPro");
        g.addNode("29");
        g.getNode("29").addAttribute("name", "Arif");
        g.getNode("29").addAttribute("age", "22");
        g.getNode("29").addAttribute("language", "Eiffel");
        g.addNode("30");
        g.getNode("30").addAttribute("name", "Puspita");
        g.getNode("30").addAttribute("age", "29");
        g.getNode("30").addAttribute("language", "Fortran");
        g.addNode("31");
        g.getNode("31").addAttribute("name", "Ari");
        g.getNode("31").addAttribute("age", "49");
        g.getNode("31").addAttribute("language", "Go");
        g.addNode("32");
        g.getNode("32").addAttribute("name", "Indra");
        g.getNode("32").addAttribute("age", "23");
        g.getNode("32").addAttribute("language", "Haskell");
        g.addNode("33");
        g.getNode("33").addAttribute("name", "Dyah");
        g.getNode("33").addAttribute("age", "35");
        g.getNode("33").addAttribute("language", "Java");
        g.addNode("34");
        g.getNode("34").addAttribute("name", "Rizki");
        g.getNode("34").addAttribute("age", "35");
        g.getNode("34").addAttribute("language", "JavaScript");
        g.addNode("35");
        g.getNode("35").addAttribute("name", "Maria");
        g.getNode("35").addAttribute("age", "18");
        g.getNode("35").addAttribute("language", "JSP");
        g.addNode("36");
        g.getNode("36").addAttribute("name", "Ratih");
        g.getNode("36").addAttribute("age", "4");
        g.getNode("36").addAttribute("language", "Lisp");
        g.addNode("37");
        g.getNode("37").addAttribute("name", "Pratiwi");
        g.getNode("37").addAttribute("age", "30");
        g.getNode("37").addAttribute("language", "Logo");
        g.addNode("38");
        g.getNode("38").addAttribute("name", "Kartika");
        g.getNode("38").addAttribute("age", "45");
        g.getNode("38").addAttribute("language", "Pascal");
        g.addNode("39");
        g.getNode("39").addAttribute("name", "Wulandari");
        g.getNode("39").addAttribute("age", "29");
        g.getNode("39").addAttribute("language", "Delphi");
        g.addNode("40");
        g.getNode("40").addAttribute("name", "Fajar");
        g.getNode("40").addAttribute("age", "28");
        g.getNode("40").addAttribute("language", "Perl");
        g.addNode("41");
        g.getNode("41").addAttribute("name", "Bayu");
        g.getNode("41").addAttribute("age", "38");
        g.getNode("41").addAttribute("language", "Prolog");
        g.addNode("42");
        g.getNode("42").addAttribute("name", "Lestari");
        g.getNode("42").addAttribute("age", "5");
        g.getNode("42").addAttribute("language", "Python");
        g.addNode("43");
        g.getNode("43").addAttribute("name", "Anita");
        g.getNode("43").addAttribute("age", "32");
        g.getNode("43").addAttribute("language", "PHP");
        g.addNode("44");
        g.getNode("44").addAttribute("name", "Muhamad");
        g.getNode("44").addAttribute("age", "16");
        g.getNode("44").addAttribute("language", "Pike");
        g.addNode("45");
        g.getNode("45").addAttribute("name", "Kusuma");
        g.getNode("45").addAttribute("age", "4");
        g.getNode("45").addAttribute("language", "R");
        g.addNode("46");
        g.getNode("46").addAttribute("name", "Rahmawati");
        g.getNode("46").addAttribute("age", "48");
        g.getNode("46").addAttribute("language", "REXX");
        g.addNode("47");
        g.getNode("47").addAttribute("name", "Fitria");
        g.getNode("47").addAttribute("age", "45");
        g.getNode("47").addAttribute("language", "REBOL");
        g.addNode("48");
        g.getNode("48").addAttribute("name", "Retno");
        g.getNode("48").addAttribute("age", "48");
        g.getNode("48").addAttribute("language", "RPG");
        g.addNode("49");
        g.getNode("49").addAttribute("name", "Kurnia");
        g.getNode("49").addAttribute("age", "40");
        g.getNode("49").addAttribute("language", "Ruby");
